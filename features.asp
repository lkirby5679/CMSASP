...
intSkin = getSkin(intSubSkin,2)
	'strCurDateString = DateToStr2(DateAdd("h", strTimeAdjust , Now()))
	...
	'response.Write("strForumTimeAdjust: " & strForumTimeAdjust & "<br>")
	...
	'getDateDiff(datetostr(strForumDateAdjust),datetostr(strPostDate))
