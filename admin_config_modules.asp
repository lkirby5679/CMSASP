...
<%	
dim iDATA1, tDATA1, iDATA2, tDATA2, iDATA3, tDATA3, iDATA4, tDATA4, iDATA5, tDATA5
dim iDATA6, tDATA6, iDATA7, tDATA7, iDATA8, tDATA8, iDATA9, tDATA9, iDATA10, tDATA10
  Err_Msg = ""
  strCMResult = ""
  pgMode = cInt(request.QueryString("mode"))
	if Request.Form("Method_Type") = "modify_config" then 
		...
		'app_users = Request.Form("g_read")
		'app_write = Request.Form("g_write")
		'app_full = Request.Form("g_full")
		...
		if Err_Msg = "" then
		  ...
		  if Request.Form("hasUpload") = "1" then
			...
			'strSql = strSql & ", UP_ALLOWEDUSERS = " & cLng(Request.Form("upLvl"))
...
Sub listAll() %>
 ...
 <% 
    ...
    <tr align="center">
      <td><a href="admin_config_modules.asp?mode=1&id=<%= cInt(rsUp("APP_ID")) %>"><img src="images/icons/icon_edit_topic.gif" title="<%= txtEdit %>" alt="<%= txtEdit %>" width="15" height="15" border="0"></a></td>
	...
	if typ = "edit" then
	  ...
	  set rsUp = my_Conn.execute(sSQL)
		if not rsUp.eof then
			...
			'strUsers = rsUp("APP_GROUPS_USERS")
		    ...
		    if not rsUpl.eof then
			  ...
			  strLvl = cLng(rsUpl("UP_ALLOWEDUSERS"))
...
<input type="hidden" name="APP_ID" value="<%= strID %>">
  <table border="0" cellspacing="0" cellpadding="0" align="center" style="width:500px;">
      ...
      <td class="tCellAlt2" width="500" align="center"> 
        <table border="0" cellspacing="1" cellpadding="1" class="tCellAlt1" width="500">
          <tr valign="middle"> 
			...
			<span class="fTitle"><%= txtCM05 %></span></td>
          </tr>
          <tr valign="middle"> 
            <td class="tSubTitle" align="center" colspan="2">
			<span class="fSubTitle"><%= ucase(strName) %></span>
            </td>
          </tr>
          <tr valign="top"> 
            <td align="right" height="25">
              <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#usize')"><img src="images/icons/icon_smile_question.gif" border="0"></a>&nbsp;&nbsp;<b><%= txtActive %>:</b>&nbsp;</td>
            <td> 
              <%= txtYes %>: 
	...
	<% If iBookmarks <> 3 and intBookmarks = 1 Then %>
          ...
          <tr valign="top"> 
            <td align="right" height="25">
              <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#usize')"><img src="images/icons/icon_smile_question.gif" border="0"></a>&nbsp;&nbsp;<b><%= txtCM06 %>:</b>&nbsp;</td>
            <td> 
              <%= txtYes %>: 
	...
	<% If iSubscriptions <> 3 and intSubscriptions = 1 Then %>
          ...
          <tr valign="top"> 
            <td align="right" height="25">
              <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#usize')"><img src="images/icons/icon_smile_question.gif" border="0"></a>&nbsp;&nbsp;<b><%= txtCM07 %>:</b>&nbsp;</td>
            <td> 
              <%= txtYes %>: 
	...
	<% End If %>
        ...
        <!-- <tr><td align="center" valign="middle"><a href="JavaScript:allowmembers('PostTopic','AuthUsers');" title="<%= txtCM10 %>"><b><%= txtCM09 %></b></a><br>
				<a href="JavaScript:DeleteSelection();" title="<%= txtCM12 %>"><b><%= txtCM11 %></b></a></td>
          <td align="center"><p><b><%= txtCM13 %></b><br>
            <select size="5" name="AuthUsers" style="width:170;" multiple>
			  <% if cInt(request.QueryString("mode")) = 1 and strUsers <> "" then
			  		getGroups(strUsers)
				 end if %>
			  <option value="0"></option>
            </select>
            <input type="hidden" name="access" value=""><br>&nbsp;</p>
          </td>
        </tr> -->
		...
		<% if showUpload and FSOenabled then
			 upl = 1 %>
          <tr valign="middle"> 
          ...
          <tr valign="middle"> 
            ...
            <td> 
              ...
              <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#uallow')"><img src="images/icons/icon_smile_question.gif" border="0"></a> 
              </td>
          </tr>
          <tr valign="middle"> 
            ...
            <td> 
              ...
              <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#usize')"><img src="images/icons/icon_smile_question.gif" border="0"></a> 
            </td>
          </tr>
          <tr valign="middle"> 
            ...
            <td> 
              ...
              <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#uextentions')"><img src="images/icons/icon_smile_question.gif" border="0"></a> 
            </td>
          </tr>
          <tr valign="middle"> 
          ...
          <tr valign="middle"> 
            ...
            <td> 
              ...
              <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#ulogfile')"><img src="images/icons/icon_smile_question.gif" border="0"></a> 
              </td>
          </tr>
          <tr valign="middle"> 
            ...
            <td> 
              ...
              <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#ulog')"><img src="images/icons/icon_smile_question.gif" border="0"></a> 
              </td>
          </tr>
          <tr valign="middle"> 
			...
			<!-- <br>
              ...
              <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#uwho')"><img src="images/icons/icon_smile_question.gif" border="0"></a> --> 
            </td>
          </tr>
			<% if showResize then %>
          <tr valign="top">
		...
		<% end if %>
          ...
          <tr valign="middle"> 
            <td colspan="2" align="center"> 
              <input type="submit" value="<%= txtSubmit %>" id="submit1" name="submit1" onclick="selectModUsers('PostTopic',<%= upl %>)" class="button">
			  &nbsp;&nbsp;
              <input type="button" value="<%= txtGoBack %>" onClick="JavaScript:history.go(-1)" id="cancel" name="cancel" class="button">
            </td>
          </tr>
        </table>
      </td>
