...
<% if (Request.QueryString("rname") = "") then %>
        <form action="register.asp?mode=Register" id="FORM1" method="post" name="FORM1">
          ...
          <input class="button" name="submit" type="submit" value="<%= txtAgree %>">&nbsp;&nbsp;
        </form>
<% else %>
        <form action="register.asp?mode=Register&rname=<%= chkString(Request.Querystring("rname"),"urlpath") %>" id="FORM1" method="post" name="FORM1">
          <input name="Refer" type="hidden" value="<% =chkString(Request.ServerVariables("HTTP_REFERER"), "refer") %>">
          <input class="button" name="submit" type="submit" value="<%= txtAgree %>">&nbsp;&nbsp;
        </form>
<% end if %>
      ...
      <td>
        <form action="JavaScript:history.go(-1)" id="FORM2" method="post" name="FORM2">
          &nbsp;&nbsp;<input class="button" name="submit" type="button" value="<%= txtCancel %>">
        </form>
      </td>
    </tr>
  </tbody>
