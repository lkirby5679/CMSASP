...
<script language="javascript" src="includes/scripts/menu_com.js"></script>
...
<tr><td width="100%">
<b><%= txtMMCHP %></b><br /><%= txtPMM1a %>.<br /><br /><%= txtPMM1b %>.<br /><br /><%= txtPMM1c %>.<br /><br />
...
<!--  START sticky items  -->
<tr><td valign="top">
<table><tr><td valign="top"><%= txtLfStky %>:<br />
...
<table><tr><td valign="top"><%= txtMnStky %>:<br />
...
<table><tr><td valign="top"><%= txtRtStky %>:<br />
