...
if cLng(Request.QueryString("cmd")) = 10 then
	if Request.QueryString("avatar") <> "" and IsNumeric(Request.QueryString("avatar")) = True then
		...
		closeAndGo("admin_avatar_home.asp?cmd=3")
	end if
end if
...
if Request.Form("Method_Type") = "avatarSettings" then
		...
		closeAndGo("admin_avatar_home.asp")
end if
...
if Request.Form("Method_Type") = "addAvatar" then 
	...
	if Session.Contents("avatarHome") = "" then
		...
		closeAndGo("admin_avatar_home.asp?cmd=1")
end if
...
<%
 ...
 %>
      <tr>
        <td class="<% =CColor %>" valign="center" align="center" nowrap><img src="<% =rs("A_URL") %>" height=<% =rsav("A_HSIZE") %> width=<% =rsav("A_WSIZE") %> border=<% =rsav("A_BORDER") %> hspace=0 title="<% =rs("A_NAME") %>" alt="<% =rs("A_NAME") %>"></td>
        ...
        <td class="<% =CColor %>" valign="center" align="center" nowrap><a href="javascript:mwpHSs('edit<% =rs("A_ID") %>','1');"><img src="images/icons/icon_pencil.gif" title="<%= txtAH24 %>" alt="<%= txtAH24 %>" border="0" hspace="0"></a>
        <a href="admin_avatar_home.asp?cmd=10&avatar=<% =rs("A_ID") %>"><img src="images/icons/icon_trashcan.gif" title="<%= txtAH25 %>" alt="<%= txtAH25 %>" border="0" hspace="0"></a></td>
      </tr>
  ...
  if FSOenabled then
    ...
    <b><%= txtAH13 %></b></div>
      ...
      <div class="menu" id="block12<%= typ %>" style="display: <%= cls %>;">
	    <a onclick="show('aa');hide('ab');hide('ac');hide('ad');hide('ae');hide('zz');" href="javascript:;"><%= icn_bar %><%= txtAH14 %><br></a>
	    <a onclick="show('ab');hide('aa');hide('ac');hide('ad');hide('ae');hide('zz');" href="javascript:;"><%= icn_bar %><%= txtAH15 %><br></a>
	    <a onclick="show('ac');hide('ab');hide('aa');hide('ad');hide('ae');hide('zz');" href="javascript:;"><%= icn_bar %><%= txtAH16 %><br></a>
	    <a onclick="show('ad');hide('ab');hide('ac');hide('aa');hide('ae');hide('zz');" href="javascript:;"><%= icn_bar %><%= txtAH32 %><br></a>
	    <% If FSOenabled = true Then %>
	    <a onclick="show('ae');hide('ab');hide('ac');hide('ad');hide('aa');hide('zz');" href="javascript:;"><%= icn_bar %><%= txtAH18 %></a>
	    <% End If %>
	  <% else %>
      <div class="menu" id="block12<%= typ %>" style="display: <%= cls %>;">
	  <a href="admin_avatar_home.asp"><%= icn_bar %><%= txtAH14 %><br></a>
