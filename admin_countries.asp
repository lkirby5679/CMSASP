...
<%
 ...
 %>
      <tr>
        <td class="<% =CColor %>" valign="center" align="left" nowrap>
        	<% =rs("CO_NAME") %></td>
        <td class="<% =CColor %>" valign="center" align="center">
        	<% =rs("CO_ABBREV") %></td>
        <td class="<% =CColor %>" valign="center" align="center">
        	<% =rs("CO_CCTLD") %></td>
         <td class="<% =CColor %>" valign="center" align="center" nowrap><img src="<% =rs("CO_FLAG") %>" border="0" hspace="0" title="<% =rs("CO_NAME") %>" alt="<% =rs("CO_NAME") %>"></td>
        <td class="<% =CColor %>" valign="center" align="center">&nbsp;
        	</td>
        <td class="<% =CColor %>" valign="center" align="center" nowrap><a onclick="javascript:mwpHSs('edit<% =rs("CO_ABBREV") %>','1');" href="javascript:;"><img src="images/icons/icon_pencil.gif" title="<%= txtCFEdit %>" alt="<%= txtCFEdit %>" border="0" hspace="0"></a>
        <a href="admin_countries.asp?cmd=10&coid=<% =rs("CO_ABBREV")%>"><img src="images/icons/icon_trashcan.gif" title="<%= txtCFDel %>" alt="<%= txtCFDel %>" border="0" hspace="0"></a></td>
      </tr>
	  <tr height="1">
