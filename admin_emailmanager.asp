...
<td class="tCellAlt1" align="right"> <a href="admin_emailmanager.asp?mode=edit&ID=<% =rs("ID") %>"><img src="images/icons/icon_pencil.gif" alt="<%=txtemEditMsg%>" border="0" hspace="0"></a>
  <a href="admin_emailmanager.asp?mode=update&ID=<% =rs("ID") %>&ARCHIVE=2"><img src="images/icons/icon_trashcan.gif" alt="<%=txtemDelMsg%>" border="0" hspace="0"></a></td>
</TR>
<%
RS.MoveNext
loop%>
