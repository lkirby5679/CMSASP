...
if strAuthType = "nt" then
	strAdmin1UserName = Session(strCookieURL & "userID")
	strAdmin1FUserName = Session(strCookieURL & "userID")
end if
if strAdmin1UserName <> "" then strUserMemberID = getMemberID(strAdmin1UserName) else strUserMemberID = -1
