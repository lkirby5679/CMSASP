...
'::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
'::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
strWebsiteDVersion = "20060716"
strWebsiteBVersion = " rc3"
...
<% If strLoginType = 1 and strLockDown = 0 and strAuthType <> "nt" Then %>
...
<% login_box() %>
	...
	<% If not isMAC Then %>
		...
		<input type="button" value="<%= txtLogin %>" id="submit1" name="submit1" class="btnLogin" onclick="javascript:openJsLayer('dogin','250','350');<% 'If varBrowser = "ie" Then response.Write(" hidFm('formEle');") %>" />
	<% Else %>
...
<input type="hidden" name="Method_Type" value="logout" />&nbsp;&nbsp;<span class="fNavMember"><%if strAuthType="nt" then %> <% =Session(strCookieURL & "username")%> (<% =Session(strCookieURL & "userid") %>)</span>&nbsp;</td>
<%else 
