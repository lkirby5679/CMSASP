...
Private Function F1(x, y, z)
    F = (x And y) Or ((Not x) And z)
End Function

Private Function G2(x, y, z)
    G = (x And z) Or (y And (Not z))
End Function

Private Function H3(x, y, z)
    H = (x Xor y Xor z)
End Function

Private Function I4(x, y, z)
    I = (y Xor (x Or (Not z)))
End Function
...
Private Sub GG(a, b, c, d, x, s, ac)
    a = AddUnsigned(a, AddUnsigned(AddUnsigned(G2(b, c, d), x), ac))
    a = RotateLeft(a, s)
    a = AddUnsigned(a, b)
End Sub

Private Sub HH(a, b, c, d, x, s, ac)
    a = AddUnsigned(a, AddUnsigned(AddUnsigned(H3(b, c, d), x), ac))
    a = RotateLeft(a, s)
    a = AddUnsigned(a, b)
End Sub

Private Sub II(a, b, c, d, x, s, ac)
    a = AddUnsigned(a, AddUnsigned(AddUnsigned(I4(b, c, d), x), ac))
    a = RotateLeft(a, s)
    a = AddUnsigned(a, b)
End Sub
...
Public Function pEncrypt(sMessage)
    Dim x
    Dim k
    Dim AA
    Dim BB
    ...
    pEncrypt = LCase(WordToHex(a) & WordToHex(b) & WordToHex(c) & WordToHex(d))
End Function
%>