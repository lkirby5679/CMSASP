...
if hasEditor = true then
  if strAllowHTML = 1 then
	if intEditor = 5 then
	  if mLev = 4 and intIsSuperAdmin then
...
<script language="javascript" type="text/javascript">
	tinyMCE.init({
		...
		<% Else %>
		plugins : "table,save,advimage,advlink,advhr,emotions,iespell,preview,print,contextmenu,paste,fullscreen",
		...
		theme_advanced_buttons2_add_before: "emotions,separator,cut,copy,paste,pastetext,separator,iespell,separator",
		theme_advanced_buttons3_add_before : "tablecontrols,separator",
		...
		//theme_advanced_disable : "hr,anchor,visualaid,formatselect",
		theme_advanced_disable : "hr,anchor,visualaid",
		<% Else %>
		theme_advanced_disable : "hr,anchor,code,visualaid,formatselect",
		<% end if %>
...
<% 
	...
	editorJS = editorJS & "var oFCKeditor = new FCKeditor('Message','550','300','" & strEditBtn & "') ;" & vbcrlf
...
<td>
  <table width="200"><tr>
	...
	<option value="Verdana" selected> -- Font Type -- </option>
    ...
    <td height="25" align="left" valign="middle" nowrap>&nbsp;</td>
          <td height="25" width="100%">
            <select class="textbox" name="size" onChange="showsize(this.options[this.selectedIndex].value)">
              <option value="3" selected><%= txtSize %></option>
              <option value="1">1</option>
              <option value="2">2</option>
              <option value="3">3</option>
              <option value="4">4</option>
...
<td align="left"><div style="width:200px;"></div><br /><textarea id="<%= fmName %>" name="<%= fmName %>" rows="15" cols="85" style="width:100%;"><%= strM %></textarea><br />
