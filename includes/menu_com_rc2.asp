...
if (mlev = 0 and strNewReg = 1) or mlev = 4 then
  if mLev = 4 and strLockDown = 1 then
...
Response.Write("<a href=""events.asp?mode=add&date=" & strForumDateAdjust & """ class=""nav_menuItem"">" & txtSglEvnt & "</a>")
Response.Write("<a href=""events.asp?mode=addseries&date=" & strForumDateAdjust & """ class=""nav_menuItem"">" & txtRecurEvnt & "</a>")
Response.Write("</div>")
end if
