...
txtSUSetupComp = "The portal setup has been completed succesfully."
txtSUChkGenSet = "Remember to check the General settings!!"
...
txtUpgrFrom = "Upgrade from"
txtSUClkBtn = "Click the install button below."
txtSUGetStart = "Lets get started with the install!"
txtSUNewInst = "New Install"
txtSUFillOutFrm = "Please fill out the form below..."
txtSUSiteName = "What is your website name..."
txtSUMySite = "My website"
txtSUSAName = "Your 'Super Admin' login name"
txtSUSameNameAs = "This is the <b>strWebMaster</b> variable in the config.asp file"
txtSUDefPass = "Choose your 'admin' password<br>The default password is ""admin"""
txtSUPassAdmin = "admin"
txtSUEnterPassAgin = "Enter the password again..."
txtSUDetEmlComp = "We have detected the the following compatable<br>email components installed on this server"
...
txtSUPIDesc = "For maximum security, be sure that you delete site_setup.asp as well as all install files. You can edit and create Announcements from the Admin Options >> Managers >> Announcements"
...
txtSUWelMsgDesc = "Thank you for downloading and installing SkyPortal. For maximum security, be sure that you delete site_setup.asp as well as all install files. You can edit this message from the Admin Options >> Managers >> Welcome."

':: portal_config table
txtSUAllRtsRes = "© 2006 [%sitename%] All Rights Reserved."
