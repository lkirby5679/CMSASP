...
%>
  <tr>
    <td align="left" class="tCellAlt1"><a name="stats"></a>
...
<% if (mlev = 4 or mlev = 3) then%>
  ...
  <tr>
    ...
    <%=displayLastSeen%>
    <p align="right"><a href="#top"><img src="themes/<%= strTheme %>/icons/icon_go_up.gif" border="0" WIDTH="15" HEIGHT="15"></a></p>
    </td>
  </tr>
<%end if%>
  ...
  <tr>
    <td align="left" class="tSubTitle" width="100%"><a name="referrers"></a>
      <span class="fTitle"><b><%= txtTop & "&nbsp;" & intTopReferrers & "&nbsp;" & txtRefers %></b></span>
    </td>
  </tr>
  <tr>
    <td align="center" class="tCellAlt1">
  ...
  <tr>
    <td align="left" class="tSubTitle" width="100%"><a name="pageview"></a>
      <span class="fTitle"><b><%= txtCelebs %></b></span>
    </td>
  </tr>
  <tr>
    <td align="center" class="tCellAlt1">
...
<% If chkApp("forums","USERS") Then %>
  <tr>
    <td align="left" class="tSubTitle" width="100%"><a name="posters"></a>
      <span class="fTitle"><b><%= txtTop & "&nbsp;" & intTopPosters & "&nbsp;" & txtPosters %></b></span>
    </td>
  </tr>
  <tr>
    <td align="center" class="tCellAlt1">
...
<% if (mlev = 4 or mlev = 3) then%>
  ...
  <tr>
    <td align="left" class="tSubTitle" width="100%"><a name="replied"></a>
      <span class="fTitle"><b><%= txtTop & "&nbsp;" & intTopReferrers & "&nbsp;" & txtRplyToTops %></b></span>
    </td>
  </tr>
  <tr>
    <td align="center" class="tCellAlt1">
  ...
  <tr>
    <td align="left" class="tSubTitle" width="100%"><a name="read"></a>
      <span class="fTitle"><b><%= txtTop & "&nbsp;" & intReadTopics & "&nbsp;" & txtRdTops %></b></span>
    </td>
  </tr>
  <tr>
    <td align="center" class="tCellAlt1">
...
<table border="0" cellpadding="0" cellspacing="5" width="100%">
	...
	<tr>
		<td><%= intCounter%>.</td>
		<td align="left"><a href="link.asp?TOPIC_ID=<%=rs("TOPIC_ID")%>"><%= rs("T_SUBJECT")%></a></td>
		<td align="center"><%= rs("T_VIEW_COUNT")%></td>
	</tr>
	<%
	intCounter = intCounter + 1
	rs.movenext
...
<table border="0" cellpadding="0" cellspacing="5" width="100%">
	...
	<tr>
		<td><%= intCounter%>.</td>
		<td align="left"><a href="link.asp?TOPIC_ID=<%=rs("TOPIC_ID")%>"><%= rs("T_SUBJECT")%></a></td>
		<td align="center"><%= rs("T_REPLIES")%></td>
	</tr>
	<%
	intCounter = intCounter + 1
	rs.movenext
