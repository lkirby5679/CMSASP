            ...
            <td height="50" colspan="2" align="center" valign="middle"> 
              <form name="jmpMenu" method="post" action="admin_menu.asp">
                ...
                <select name="menu" onChange="submit()">
                  ...
                  <option value="<%= rsDist("iName") %>" selected><%= rsDist("mnuTitle") %></option>
                  <% Else
...
<!-- ####################### Start Add New Menu Form ########################### -->
  ...
  <table width="500" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" class="tCellAlt1">
    ...
    <tr> 
      ...
      <td width="74" align="center"><%= txtMnuLnk %> <img src="themes/<%= strTheme %>/mnu_icons/icon_question.gif" width="15" height="15" onClick="popHelp('link')" alt="<%= txtHelp %>" title="<%= txtHelp %>" style="cursor:pointer;"></td>
      <td width="74" align="center"><%= txtMnuImg %> <img src="themes/<%= strTheme %>/mnu_icons/icon_question.gif" width="15" height="15" onClick="popHelp('image')" alt="<%= txtHelp %>" title="<%= txtHelp %>" style="cursor:pointer;"></td>
      <td width="74" align="center"><%= txtMnuOc %> <img src="themes/<%= strTheme %>/mnu_icons/icon_question.gif" width="15" height="15" onClick="popHelp('onClick')" alt="<%= txtHelp %>" title="<%= txtHelp %>" style="cursor:pointer;"></td>
    ...
    <tr> 
      ...
      <td align="center"> 
        <select class="textbox" name="Ctarget">
          <option value="_parent" selected><%= txtCurrent %></option>
	...
	<% If FSOenabled Then %>
            ...
            &nbsp; <img src="themes/<%= strTheme %>/mnu_icons/icon_question.gif" width="15" height="15" onClick="popHelp('Function')" alt="<%= txtHelp %>" title="<%= txtHelp %>" style="cursor:pointer;"/>
	<% Else %>
    ...
    <tr> 
      ...
      <td align="center"> 
        <select class="textbox" name="Ptarget">
          ...
          <option value="_blank" selected><%= txtNew %></option>
          <option value="_search"><%= txtSearch %></option>
          ...
          <option value="_parent"><%= txtCurrent %></option>
          <option value="_blank"><%= txtNew %></option>
          <option value="_search" selected><%= txtSearch %></option>
          <% End If %>
        </select>
	<% If FSOenabled Then %>
      </td>
...
<form name="ParentAdd" id="ParentAdd" method="post" action="admin_menu.asp" onSubmit="selectAll('ParentAdd','g_read');">
  ...
  <table width="95%" cellpadding="2" cellspacing="0" border="1" bordercolor="#FFFFFF" align="center">
	...
	<tr>
      ...
      <td> 
        <input class="textbox" name="Clink" type="text" id="Clink" size="12" value="">
		&nbsp;<img src="themes/<%= strTheme %>/mnu_icons/icon_question.gif" width="15" height="15" onClick="popHelp('link')" alt="<%= txtHelp %>" title="<%= txtHelp %>" style="cursor:pointer;"/>
      </td>
    </tr>
	<tr>
      ...
      <td> 
        <input class="textbox" name="CImage" type="text" id="CImage" size="12" value="">
		&nbsp;<img src="themes/<%= strTheme %>/mnu_icons/icon_question.gif" width="15" height="15" onClick="popHelp('image')" alt="<%= txtHelp %>" title="<%= txtHelp %>" style="cursor:pointer;"/>
      </td>
    </tr>
	<tr>
      ...
      <td> 
        <input class="textbox" name="ConClick" type="text" id="ConClick" size="12" value="">
		&nbsp;<img src="themes/<%= strTheme %>/mnu_icons/icon_question.gif" width="15" height="15" onClick="popHelp('onClick')" alt="<%= txtHelp %>" title="<%= txtHelp %>" style="cursor:pointer;"/>
	<% If FSOenabled Then %>
      </td>
    </tr>
        <tr> 
	...
	<tr>
      ...
      <td> 
		...
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="themes/<%= strTheme %>/mnu_icons/icon_question.gif" width="15" height="15" onClick="popHelp('target')" alt="<%= txtHelp %>" title="<%= txtHelp %>" style="cursor:pointer;"/>
      </td>
    </tr>
	<tr>
      ...
      <td> 
        <%= addList %>
		&nbsp; <img src="themes/<%= strTheme %>/mnu_icons/icon_question.gif" width="15" height="15" onClick="popHelp('addmenu')" alt="<%= txtHelp %>" title="<%= txtHelp %>" style="cursor:pointer;"/>
      </td>
    </tr>
        <tr> 
            ...
            <table width="100%" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
              ...
              <tr> 
                ...
                <td> 
                  ...
                  &nbsp; <img src="themes/<%= strTheme %>/mnu_icons/icon_question.gif" width="15" height="15" onClick="popHelp('link')" alt="<%= txtHelp %>" title="<%= txtHelp %>" style="cursor:pointer;"/></td>
              </tr>
              <tr> 
                <td align="right" valign="middle"><%= txtMnuImg %>:&nbsp; </td>
                <td> 
                  <input class="textbox" name="CImage" type="text" id="CImage" size="15" value="">
                  &nbsp; <img src="themes/<%= strTheme %>/mnu_icons/icon_question.gif" width="15" height="15" onClick="popHelp('image')" alt="<%= txtHelp %>" title="<%= txtHelp %>" style="cursor:pointer;"/></td>
              </tr>
              <tr> 
                <td align="right" valign="middle"><%= txtMnuOc %>:&nbsp; </td>
                <td> 
                  <input class="textbox" name="ConClick" type="text" id="ConClick" size="15" value="">
                  &nbsp; <img src="themes/<%= strTheme %>/mnu_icons/icon_question.gif" width="15" height="15" onClick="popHelp('onClick')" alt="<%= txtHelp %>" title="<%= txtHelp %>" style="cursor:pointer;"/></td>
              </tr>
	<% If FSOenabled Then %>
        <tr> 
          <td align="right" valign="middle"><%= txtMnuFct %>:&nbsp;</td>
...
sub showChildrenForm(nam,ct)
  if nam(ct,13) <> "" then
	...
	if not rsCedit.eof then 
	  fa = 0
	  reDim arrSub(rsCedit("subCnt")-1,16)
        ...
        <tr> 
          <td align="right"> 
              ...
              <% call addChildLinkForm(arrSub,cnt)
        		...
        		if trim(arrSub(cnt,3)) = "" and arrSub(cnt,16) > 0 then
...
sub UpdateOrderForm(ord,ct)
  ...
  set rsUpOrd = my_Conn.Execute(sSql)
	if not rsUpOrd.eof then 
	  up = 0
	  reDim upOrd(rsUpOrd("subCnt")-1,12)
              ...
              <tr> 
                ...
                <td align="left">
                  <select name="mnuOrder<%= uo+1 %>">
                    <% for Ucnt = 1 to upOrd(0,9)
						if Ucnt = upOrd(uo,7) then %>
                    <option value="<%= Ucnt %>" selected><%= Ucnt %></option>
                    <% Else %>
...
sub mnuAccessBlock(f,g) %>
  ...
  <legend><b>Group Access</b>&nbsp;&nbsp;<img src="themes/<%= strTheme %>/mnu_icons/icon_question.gif" width="15" height="15" onClick="popHelp('grpAccess');" alt="<%= txtHelp %>" title="<%= txtHelp %>" style="cursor:pointer;"/></legend><br>
