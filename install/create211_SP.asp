...
'PORTAL_APPS
	...
	strSql = "UPDATE " & strTablePrefix & "APPS SET APP_GROUPS_USERS = '1,2', APP_DATE = '" & datetostr2(now()) & "' WHERE APP_iNAME = 'PM';"
	executeThis(strSql)
...
'PORTAL_MEMBERS
	...
	strSQL = "UPDATE " & strMemberTablePrefix & "MEMBERS SET M_LCID=" & intPortalLCID & ", M_TIME_OFFSET=0,M_TIME_TYPE='12',THEME_ID ='0',M_DONATE = 0, M_PMSTATUS = 1, M_LANG = 'en' WHERE MEMBER_ID <> 0"
	populateA(checkIt(strSql))
...
'PORTAL_CONFIG - 
	...
	strSQL = "UPDATE " & strTablePrefix & "CONFIG SET C_STRDEFTHEME='" & installTheme & "'"
		...
		strSql = strSql & ", C_ONEADAYDATE='" & datetostr2(date()) & "'"
