...
<%
  Dim iPgType, iMode, pmid, intAppID, pm_mid, stMessage
...
elseif chkAPP("PM","USERS") and chkPMaccess(strUserMemberID) then
	...
	if not rsA.eof then
	  ...
	  iPMfolderAccess = rsA("APP_iDATA6")
	else
	  intAppID = 0
	end if
...
Response.Write("<table class=""tPlain"" width=""100%"" cellpadding=""4"">")
%>
  <tr>
...
<%    end if %>
    ...
    <td class="tCellAlt0" valign="top" width="100%">
...
%><table class="tPlain" width="100%">
 ...
 <table border="0" width="100%" cellspacing="1" cellpadding="4">
  <tr>
    <td align="center" class="fSubTitle" nowrap><b><%= txtFrom %></b></td>
    <td align="left" class="fSubTitle"><b><%= txtSubject %>:&nbsp;&nbsp; <% =rsMessage("M_SUBJECT") %></b></td>
  </tr>
  <tr>
    <td class="tCellAlt0" valign="top"><% 
	  		strIMmsg = txtView & " " & ChkString(rs("M_NAME"),"display") & "'s " & txtProfile %>
...
<tr><td height="30">
&nbsp;&nbsp;&nbsp;<img src="themes/<%= strTheme %>/icon_pmold.gif" align="middle" border="0" width="24" height="18">&nbsp;<%= replace(txtSntMsgCnt,"[%count%]",oboxcount) %>:
</td></tr>
<tr><td>
<table cellspacing="1" cellpadding="4" width="100%">
  <tr class="tSubTitle">
    <td valign="middle">&nbsp;</td>
    <td valign="middle"><span class="fSubTitle"><B><%= txtSubject %></B></span></td>
    <td valign="middle" nowrap><span class="fSubTitle"><B><%= txtSntTo %></B></span></td>
    <td valign="middle" nowrap><span class="fSubTitle"><B><%= txtDtSnt %></B></span></td>
    <td valign="middle"><span class="fSubTitle"><B><%= txtRemove %>?</B></span></td>
  </tr>
<%
...
%>
  <tr>
    <td>&nbsp;</td>
    <td colspan="4"><b><%= txtNoSentPMs %></b></td>
  </tr>
<%	else
	        i = 0
...
%>	
  <tr>
    <td colspan="5" align=center class="<% =CColor %>"><%= txtMemDel %></td>
  </tr>
<%	
	else
%>
  <tr>
    <td align="center" width="20" class="<% =CColor %>">
    ...
    <td class="<% =CColor %>"><a href="pm.asp?cmd=5&amp;pmid=<% =rsFMessage("M_ID") %>"><% =chkString(rsFMessage("M_SUBJECT"),"display") %></a></td>
    <td width="100" class="<% =CColor %>">
    ...
    <td nowrap width="175" class="<% =CColor %>"><% =ChkDate(rsFMessage("M_SENT")) %>&nbsp;&nbsp;<% =ChkTime(rsFMessage("M_SENT")) %></td>
    <td align="center" width="60" class="<% =CColor %>"><input type="checkbox" name="Remove" value="<% =rsFMessage("M_ID") %>"></td>
  </tr>
<%            end if
		rsFMessage.MoveNext
		i = i + 1
...
set rsMPcount = nothing
  ...
  <%
   ...
   If iAutoDelete then %>
<tr><td height="30" align="center" valign="middle"><b><%= replace(txtDelPMDays,"[%days%]",iAutoDelDays) %></b></td></tr>
<% end if %>
<tr><td height="30" valign="middle">&nbsp;&nbsp;&nbsp;<img src="themes/<%= strTheme %>/icon_pmnew.gif" align="middle" border="0" width="24" height="18">&nbsp;<%= replace(txtCntUnread,"[%count%]",pmcot) %>:</td></tr>
<tr><td>
...
%>
      ...
      <tr>
        <td align="center" class="<% =CColor %>" width="20">
        ...
        <td class="<% =CColor %>"><a href="pm.asp?cmd=4&amp;pmid=<% =chkString(rsMessage("M_ID"),"display") %>"><% =replace(chkString(rsMessage("M_SUBJECT"),"display"),"''","'") %></a></td>
        <td class="<% =CColor %>" width="100">
	  <a href="cp_main.asp?cmd=8&member=<% =chkString(rsMessage("M_FROM"),"display") %>"><%= displayName(ChkString(rsFrom("M_NAME"),"display"),rsFrom("M_GLOW")) %></a>
		...
		<td nowrap class="<% =CColor %>" width="175"><% =ChkDate(rsMessage("M_SENT")) %>&nbsp;&nbsp;<% =ChkTime(rsMessage("M_SENT")) %></td>
        <td align="center" class="<% =CColor %>" width="50"><input type="checkbox" name="DELETE" value="<% =chkString(rsMessage("M_ID"),"display") %>"></td>
      </tr>
<%	
	    rsMessage.MoveNext
	    i = i + 1
...
if stMessage <> "" then %>
<tr><td height="30" valign="middle"><%= stMessage %></td></tr>
<%
end if %>
<tr><td height="30" valign="middle">&nbsp;&nbsp;&nbsp;<img src="themes/<%= strTheme %>/icon_pmnew.gif" align="middle" border="0" width="24" height="18">&nbsp;&nbsp;<%= replace(txtCntUnread,"[%count%]",pmcot) %>:</td></tr>
<tr><td>
...
%>
      <tr>
        <td>&nbsp;</td>
        <td colspan="4"><b><%= txtNoSvdPMs %></b></td>
      </tr>
<% else
        i = 0
      	do Until rsMessage.EOF
...
%>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td align="left" width="50%"><b>&nbsp;<%= txtRemRetInbox %>.</b>
        </td>
        <td align="right">
		<br><%= txtSelAll %> &nbsp;&nbsp;
		<input type="checkbox" name="markall" onClick="CheckAll('DELETE');">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><br>
...
<% end if %>
	<td align="left" valign="top" width="95" height="40">
	<div unselectable='on' style="position:absolute;margin-left:1;margin-right:1;width:93;height:37";>
       <div unselectable='on' style="position:absolute;clip: rect(0 90px 37px 0)"><a href="javascript:;" onclick="JavaScript:openWindow4('pm_pop.asp?mode=3&amp;cid=<%=pmid%>');">
