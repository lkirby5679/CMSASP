...
if request.querystring("mode")= "deleted" then
  ...
  cNum = cint(request.form("cNum"))
	...
	strSql = strSql & " WHERE M_POSTS <= " & cPosts & " AND M_LASTHEREDATE < '" & datetostr2(DateAdd("d", cDays*-1+1 , now())) & "' AND M_LEVEL = 1 AND M_STATUS = 1"
...
%>
	...
	if Session.Contents("memberHome") <> "" then
      showUpdResult("<ul>" & Session.Contents("memberHome") & "</ul>")
...
<table border="0" cellspacing="1" cellpadding="1" width="100%">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right" width="50%"><b><%= txtFllName %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtMPic %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
    ...
    <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#Picture')"><img src="images/icons/icon_smile_question.gif" border="0"></a>
    </td>
  </tr>
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtShoRecTopics %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
    ...
    <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#RecentTopics')"><img src="images/icons/icon_smile_question.gif" border="0"></a>
    </td>
  </tr>
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb31 %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
    ...
    <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtAge %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCity %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtState %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtZipCd %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCntry %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtMSN %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtICQ %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtYhoIM %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtAIM %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtOcc %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
    ...
    <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#Occupation')"><img src="images/icons/icon_smile_question.gif" border="0"></a>
    </td>
  </tr>
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtHmPg %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
    ...
    <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#homepages')"><img src="images/icons/icon_smile_question.gif" border="0"></a>
    </td>
  </tr>
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtFavLinks %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
    ...
    <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#FavLinks')"><img src="images/icons/icon_smile_question.gif" border="0"></a>
    </td>
  </tr>
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtMarStat %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb32 %>:</b><br>
    ...
    <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#Vars1to4')"><img src="images/icons/icon_smile_question.gif" border="0"></a>
    </td>
  </tr>
   <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb33 %>:</b><br>
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb34 %>:</b><br>
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb35 %>:</b><br>
...
<table border="0" cellspacing="1" cellpadding="1">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb03 %>:</b>&nbsp;</td>
    <td class="tCellAlt0">
    ...
    <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#ShowRank')"><img src="images/icons/icon_smile_question.gif" border="0"></a>
    </td>
  </tr>
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb08 %>:</b>&nbsp;</td>
    <td class="tCellAlt0"><input type="text" name="strRankAdmin" size="30" value="<% if strRankAdmin <> " " then Response.Write(strRankAdmin) end if %>">
    <img src="images/icons/icon_smile_question.gif" border="0" alt="(<%= txtAdminst %>)"></td>
  </tr>
  <tr valign="top">
    <td class="tCellAlt0" align=right><b><%= txtCMb07 %>:</b></td>
    <td class="tCellAlt0">
    ...
    <a href="JavaScript:openWindow3('pop_help.asp?mode=2&place=1#RankColor')"><img src="images/icons/icon_smile_question.gif" border="0"></a>
    </td>
  </tr>
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb09 %>:</b>&nbsp;</td>
    <td class="tCellAlt0"><input type="text" name="strRankMod" size="30" value="<% if strRankMod <> " " then Response.Write(strRankMod) end if %>">
    <img src="images/icons/icon_smile_question.gif" border="0" alt="(<%= txtModerator %>)">
    </td>
  </tr>
  <tr valign="top">
    <td class="tCellAlt0" align=right><b><%= txtCMb07 %>:</b></td>
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb10 %>:</b>&nbsp;</td>
    <td class="tCellAlt0"><input type="text" name="strRankLevel0" size="30" value="<% if strRankLevel0 <> " " then Response.Write(strRankLevel0) else Response.Write("Starting Member") end if %>">
    <b><%= txtPosts %>:</b>&nbsp;<input type="text" name="intRankLevel0" size="5" value="0">
    <img src="images/icons/icon_smile_question.gif" border="0" alt="(<%= txtCMb16 %>)">
    </td>
  </tr>
  <tr valign="top">
    <td class="tCellAlt0" align=right><b><%= txtCMb07 %>:</b></td>
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb11 %>:</b>&nbsp;</td>
    <td class="tCellAlt0"><input type="text" name="strRankLevel1" size="30" value="<% if strRankLevel1 <> " " then Response.Write(strRankLevel1) end if %>">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb12 %>:</b>&nbsp;</td>
    <td class="tCellAlt0"><input type="text" name="strRankLevel2" size="30" value="<% if strRankLevel2 <> " " then Response.Write(strRankLevel2) end if %>">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb13 %>:</b>&nbsp;</td>
    <td class="tCellAlt0"><input type="text" name="strRankLevel3" size="30" value="<% if strRankLevel3 <> " " then Response.Write(strRankLevel3) end if %>">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb14 %>:</b>&nbsp;</td>
    <td class="tCellAlt0"><input type="text" name="strRankLevel4" size="30" value="<% if strRankLevel4 <> " " then Response.Write(strRankLevel4) end if %>">
  ...
  <tr valign="top">
    <td class="tCellAlt0" align="right"><b><%= txtCMb15 %>:</b>&nbsp;</td>
    <td class="tCellAlt0"><input type="text" name="strRankLevel5" size="30" value="<% if strRankLevel5 <> " " then Response.Write(strRankLevel5) end if %>">
  ...
  <tr valign="top">
    <td class="tCellAlt0" colspan="2" align="center"><br><input type="submit" value="<%= txtSubmit %>" id="submit1" name="submit1" class="button">&nbsp;&nbsp;&nbsp;<input type="reset" value="<%= txtReset %>" id="reset1" name="reset1" class="button"><br>&nbsp;</td>
  </tr>
</table>
    </td>
  </tr>
...
<tr>
	<td class="tCellAlt1"><input type="submit" value="<%= txtCMb40 %>" class="button"></td>
</tr></form>
	</table>
	</td>
  </tr>
...
<form method="post" action="admin_config_members.asp?cmd=2&mode=deleted">
  <tr>
<td class="tCellAlt1"><%= replace(txtCMb42,"[%count%]",memCount) %></td>
  </tr>
  <tr>
<td class="tCellAlt1">
